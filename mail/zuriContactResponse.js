...
const zuriContactResponse = async ({email,name,checkin,checkout,room,phone,userEmail}) => {
    ...
    try {
        ...
        sendMail(email, "Contact Form", "zuriContact", {name,checkin,checkout,room,phone,userEmail})
